...
agent_card = AgentCard(
        ...
        supported_interfaces = [
            ...
            AgentInterface(
                url = "http://localhost:9999/", protocol_binding = "JSONRPC", protocol_version = "0.3" ##, tenant = "default"
            )
        ],
...
server = A2AStarletteApplication(
        ...
        enable_v0_3_compat = True ######## compatibility must be enabled!!!!!!! Whether to enable v0.3 backward compatibility on the same endpoint.
    )

import uvicorn
print("A2A server v 1.0 with compatibility for 0.3")
